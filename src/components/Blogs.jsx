...
import skillSprint from '../Assets/SkillSprint.jpeg';
...
const Blogs = () => {
  return (
    <div name='blogs' className='w-full bg-[#0a192f] pt-3'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-4 lg:w-[1200px] w-auto lg:mx-auto'>
        <SingleProject
          topic="Skill Sprint - Micro Service project"
          desc="This project used microservice Software Architecture and the Springboot and the React JS."
          image={skillSprint}
          url="https://github.com/IsuruX98/SkillSprint-Frontend"
        />
        <SingleProject
