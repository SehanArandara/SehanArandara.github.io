...
const AboutMe = () => {
    return (
        <div name='aboutme' className=' w-full mx-auto  bg-[#0a192f] pt-3'>
            ...
            <h3 className='text-[#8892b0] text-1xl text-center lg:text-1xl font-bold  mb-6 '>Intern - Software Engineer & DevOps Engineer</h3>
            <div className='lg:flex justify-center text-gray-300 lg:w-[1200px] mx-auto lg:mt-0'>
                ...
                <div className='lg:ml-12 flex flex-col justify-between p-4'>
                    ...
                    <p className=' text-justify lg:p-0 mt-5 '>I'm a Bsc (Hons) software engineering student at the Sri Lankan Institute of Information Technology .I'm passionate about software engineer . I have strong coding skills in Java and Python , and I'm familiar with software development methodologies . I'm eager to learn and contribute to meaningful project with a dynamin team .
                    </p>

                    <h1 className='font-bold  lg:text-4xl text-2xl text-center lg:text-left mt-4 lg:mt-5 '>Interested In</h1>
                    <p className=' text-justify lg:p-0 '>Software Engineer <br /> DevOps Engineer <br />Cloud Engineer <br />AI/ML Engineer</p>
